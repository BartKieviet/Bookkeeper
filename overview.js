...
//Stolen from Pardus	
var res_names = {'1': 'Food', '2': 'Energy', '3': 'Water', '4': 'Animal embryos', '5': 'Ore', '6': 'Metal', '7': 'Electronics', '8': 'Robots', '9': 'Heavy plastics', '10': 'Hand weapons', '11': 'Medicines', '12': 'Nebula gas', '13': 'Chemical supplies', '14': 'Gem stones', '15': 'Liquor', '16': 'Hydrogen fuel', '17': 'Exotic matter', '18': 'Optical components', '19': 'Radioactive cells', '20': 'Droid modules', '21': 'Bio-waste', '22': 'Leech baby', '23': 'Nutrient clods', '24': 'Cybernetic X-993 Parts', '25': 'X-993 Repair-Drone', '26': 'Neural Stimulator', '27': 'Battleweapon Parts', '28': 'Neural Tissue', '29': 'Stim Chip', '30': 'Capri Stim', '31': 'Crimson Stim', '32': 'Amber Stim', '50': 'Slaves', '51': 'Drugs', '100': 'Package', '101': 'Faction package', '102': 'Explosives', '103': 'VIP', '104': 'Christmas Glitter', '105': 'Military Explosives', '150': 'Exotic Crystal', '151': 'Feral Egg', '201': 'Human intestines', '202': 'Skaari limbs', '203': 'Keldon brains', '204': 'Rashkir bones', '211': 'Blue Sapphire jewels', '212': 'Ruby jewels', '213': 'Golden Beryl jewels'};
	...
	function addBuilding (loc) {
		...
		function addBuildingData(data) {
			...
			for (var res in data.amount) {
				...
				var cell = document.createElement("td");
				cell.textContent = data.amount[res];
				table.lastChild.appendChild(cell);
				}
			}
		}
